...
(function() {
  ...
  Backbone.Controllers.TasksController = (function(_super) {
    ...
    function TasksController() {
      this.start = __bind(this.start, this);      this.mainRegion = new Backbone.Diorama.ManagedRegion();
